...
public class ExcelVisualizer {
    public static void main(String[] args) {
        ...
        int [][] spreadSheet = new int [][]{  row1, row2, row3, row4, row5, row6  };
       ...
       // in this 2D array object, we have 3 1D array object stored
        ...
        System.out.println(Arrays.toString(myExcel[0]));//seeing what's inside of first 1 D array
        System.out.println(myExcel[0].length);// getting the length of first 1D array
        System.out.println(myExcel[1].length);// getting the length of first 1D array
        System.out.println(myExcel[2].length);// getting the length of first 1D array

     // how can I make above code better by looping and get the item count of each 1D array
