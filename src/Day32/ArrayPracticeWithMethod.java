...
public class ArrayPracticeWithMethod {
    public static void main(String[] args) {
        ...
        compare2ArraysSize(new String[] {"Sergin" , "Senay" , "Astrid"}, new String [] {"Araz"});
    ...
    public static void compare2ArraysSize(String [] arr1 , String [] arr2) {
        if (arr1.length > arr2.length) {
            System.out.println("array 1 has more items");
        } else if (arr1.length > arr2.length) {
            System.out.println("array 2 has more items");
        } else {
            System.out.println("they have the same item count");
        }
        // OPTIONALLY
