...
assume that the order of grocery Items match the prices in same order.*/
        //String [] groceryItems = new String [6] ;-this method is used if I do not know what
        // I am going to store there
        ...
        System.out.println("\n--------no arrow after kiwi-------------");
        //print everything in one line with arrow and do not put an arrow after last one
        //assume that you know the last item is a kiwi
        // if the fruit that you are checking is kiwi, just do not add it
        ...
        // groceryItems[groceryItems.length - 1]--> this is one shot way for last three lines above

        for (String eachFruit : groceryItems) {

            System.out.print(eachFruit);
            //only print an arrow when the fruit is not last item
