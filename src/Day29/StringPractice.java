...
public class StringPractice {
    public static void main(String[] args) {
        ...
        //Logic 1: split thisString by dash -
        //to get 2 pieces of String into String array

        String [] heroSplit = hero1.split("-");
        System.out.println("heroSplit = " + Arrays.toString(heroSplit) );//heroSplit = [Superman, Clark Kent]
        ...
        //this prints the same as above: hero code is Superman and Identity is Clark Kent
